...
function DestinationManagement() {
    ...
    const openEditModal = (destination) => {
        setFormData({
            ...
            destinationImage: '', // Not retaining existing file input
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="mb-12 text-center">
                    ...
                    <p className="text-gray-600 mt-2 font-light">
                        Curate and manage our exclusive collection of premium travel destinations
                    </p>
                </div>
                    ...
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                        <div className="flex-1">
                            <div className="relative">
                                <input
                                    ...
                                    className="w-full pl-10 pr-4 py-3 border-0 bg-gray-50 rounded-lg focus:ring-2 focus:ring-indigo-300 transition-all"
                                />
                        ...
                        <div className="flex-shrink-0">
                            <select
                                ...
                                className="mr-2 px-4 py-3 border-0 bg-gray-50 rounded-lg focus:ring-2 focus:ring-indigo-300 transition-all"
                            >
                            ...
                            <button
                                ...
                                className="bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-3 rounded-lg shadow-md transition duration-200 ease-in-out flex items-center justify-center"
                                disabled={loading}
                            >
                ...
                {/* Message Display */}
                {message.text && (
                    <div className={`mb-8 p-4 rounded-lg text-center shadow-md transition-all duration-300 ${
                ...
                {loading && (
                    <div className="text-center py-10">
                        ...
                        <p className="mt-3 text-gray-600">Loading destinations...</p>
                    </div>
                )}
                        ...
                        {filteredDestinations.length === 0 ? (
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                                {filteredDestinations.map(destination => (
                                    <div key={destination.id} className="bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
                                        ...
                                        <div className="p-6">
                                            <div className="flex justify-between items-start mb-2">
                                                <h3 className="text-xl font-serif font-semibold text-gray-900">{destination.destinationName}</h3>
                                            </div>
                                            <p className="text-gray-500 text-sm mb-4">{getRegionDisplayName(destination.region)}</p>
                                            <p className="text-gray-600 mb-6 line-clamp-3">{destination.destinationDescription}</p>
                                            ...
                                            <div className="flex justify-end space-x-2">
                                                <button
                                                    ...
                                                    className="px-4 py-2 border border-indigo-500 text-indigo-500 hover:bg-indigo-50 rounded-md transition"
                                                >
                                                    Edit
                                                </button>
                                                <button
                                                    onClick={() => handleDelete(destination.id)}
                                                    className="px-4 py-2 border border-red-500 text-red-500 hover:bg-red-50 rounded-md transition"
                                                >
                                                    Delete
                                                </button>
                                            </div>
                        ...
                        <div className="p-8">
                            ...
                            <form onSubmit={handleSubmit}>
                                <div className="space-y-6">
                                    ...
                                    <div>
                                        ...
                                        <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 flex flex-col items-center">
                                            ...
                                            <p className="text-sm text-gray-500 mb-2">Drag and drop image here, or</p>
                                            <input
                                                type="file"
                                                id="destinationImage"
                                            ...
                                            <label
                                                ...
                                                className="cursor-pointer bg-indigo-50 hover:bg-indigo-100 text-indigo-600 px-4 py-2 rounded-md text-sm font-medium transition"
                                            >
                                                Browse Files
                                            </label>
                                ...
                                <div className="mt-8 flex justify-end gap-4">
                                    ...
                                    <button
                                        type="submit"
                                        className="px-6 py-3 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 shadow-md transition"
                                        disabled={loading}
                                    >
                    ...
                    <div className="bg-white rounded-2xl p-8 max-w-md w-full mx-4 shadow-2xl">
                        ...
                        <div className="flex justify-center gap-4">
                            ...
                            <button
                                ...
                                className="px-6 py-3 bg-red-500 text-white rounded-lg hover:bg-red-600 shadow-md transition flex-1"
                                disabled={loading}
                            >
